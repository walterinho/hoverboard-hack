...
void mL_BLDCMotor(void){
  ...
  if (motorL.hallpos == 0 && motorL.lasthallpos == 5) {
    motorL.motorpos--;
  } else if (motorL.hallpos == 5 && motorL.lasthallpos == 0) {
    motorL.motorpos++;
  } else if (motorL.hallpos > motorL.lasthallpos) {
    motorL.motorpos--;
  } else {
    motorL.motorpos++;
  }
  motorL.lasthallpos = motorL.hallpos;
}
